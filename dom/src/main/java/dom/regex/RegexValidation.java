...
public final class RegexValidation {
	public static final class ValidaNombres {
		...
		public static final String CODIGOPOSTAL = "[0-9]{4}$+";
	}
	...
	public static final class ValidaMatricula {
		...
		public static final String MATRICULA = "[0-9,.]+";
	...
	public static final class ValidaRangoHorario {

		private ValidaRangoHorario() {
		}
